#!/usr/bin/env python3
"""Script to create Synology secrets in the database.
...
# Change to mcp_server_files directory to ensure we use the correct database
MCP_SERVER_DIR = Path(__file__).parent / "mcp_server_files"
